    ...
    <div className={classes["footer-category"]}>
      <div className="container">
        ...
        <div className={classes["footer-category-box"]}>
          ...
          <li onClick={handleClick} className={classes["footerLink"]} name="Shorts+Jeans" style={{ color: color.footerBody }}>&nbsp; shorts & jeans &nbsp; |</li>
          <li onClick={handleClick} className={classes["footerLink"]} name="Jacket" style={{ color: color.footerBody }}>&nbsp; jacket &nbsp; |</li>
          <li onClick={handleClick} className={classes["footerLink"]} name="Dress+Frock" style={{ color: color.footerBody }}>&nbsp; dress & frock &nbsp; |</li>
        ...
        <div className={classes["footer-category-box"]}>
          ...
          <li onClick={handleClick} className={classes["footerLink"]} name="Cowboy+Shoes" style={{ color: color.footerBody }}>&nbsp; cowboy shoes &nbsp; |</li>
          <li onClick={handleClick} className={classes["footerLink"]} name="Safety+Shoes" style={{ color: color.footerBody }}>&nbsp; safety shoes &nbsp; |</li>
          <li onClick={handleClick} className={classes["footerLink"]} name="Party+Wear+Shoes" style={{ color: color.footerBody }}>&nbsp; Party wear shoes &nbsp; |</li>
          ...
          <li onClick={handleClick} className={classes["footerLink"]} name="Long+Shoes" style={{ color: color.footerBody }}>&nbsp; Long shoes &nbsp;</li>
        </div>
        ...
        <div className={classes["footer-category-box"]}>
          ...
          <li onClick={handleClick} className={classes["footerLink"]} name="Earrings" style={{ color: color.footerBody }}>&nbsp; Earrings &nbsp; |</li>
          <li onClick={handleClick} className={classes["footerLink"]} name="Couple+Rings" style={{ color: color.footerBody }}>&nbsp; Couple rings &nbsp;</li>
        </div>
        ...
        <div className={classes["footer-category-box"]}>
          ...
          <li onClick={handleClick} className={classes["footerLink"]} name="Makeup+Kit" style={{ color: color.footerBody }}>&nbsp; makeup kit&nbsp;|</li>
          ...
          <li onClick={handleClick} className={classes["footerLink"]} name="Body+Soap" style={{ color: color.footerBody }}>&nbsp; Body soap&nbsp; |</li>
          <li onClick={handleClick} className={classes["footerLink"]} name="Scrub" style={{ color: color.footerBody }}>&nbsp; scrub&nbsp; |</li>
          <li onClick={handleClick} className={classes["footerLink"]} name="Hair+Gel" style={{ color: color.footerBody }}>&nbsp; hair gel&nbsp; |</li>
          <li onClick={handleClick} className={classes["footerLink"]} name="Hair+Colors" style={{ color: color.footerBody }}>&nbsp; hair colors&nbsp; |</li>
          <li onClick={handleClick} className={classes["footerLink"]} name="Hair+Dye" style={{ color: color.footerBody }}>&nbsp; hair dye &nbsp; |</li>
          <li onClick={handleClick} className={classes["footerLink"]} name="Sunscreen" style={{ color: color.footerBody }}>&nbsp; sunscreen&nbsp; |</li>
          <li onClick={handleClick} className={classes["footerLink"]} name="Skin+Lotion" style={{ color: color.footerBody }}>&nbsp; skin lotion&nbsp; </li>
        </div>
      </div>
    </div>
  );
